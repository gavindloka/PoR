  ...
  const HomePage = () => {
    ...
    return (
      <>
        <div className="w-full m-auto bg-transparent pt-10 px-20 font-satoshi">
          <FloatingElements />
          <motion.div
          ...
          >
            ...
            <motion.div className="w-full flex items-end justify-center gap-10">
              ...
              <motion.div
                className="w-48 h-48 rounded-xl overflow-hidden relative border bg-purple-100 border-purple-600"
                initial={{ opacity: 0, x: -50 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 1.2 }}
              >
                <div className="absolute top-0 right-0 w-24 h-24 text-white/10 rounded-full -translate-y-1/2 translate-x-1/2 blur-xl"></div>
                <div className="absolute bottom-0 left-0 w-16 h-16 text-purple-300/20 rounded-full translate-y-1/2 -translate-x-1/2 blur-md"></div>
                  ...
                  <div className="flex flex-col items-center justify-center flex-grow">
                    ...
                    >
                      <CountUp
                        ...
                        separator=","
                        duration={2}
                        className="count-up-text text-purple-600"
                      />
                    </motion.div>
                  </div>
